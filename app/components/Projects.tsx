...
const projects: Project[] = [
  {
    ...
    device: "desktop",
    desc: "Pengembangan website resmi Masjid Raya An-Nur Provinsi Riau untuk menyajikan informasi profil, layanan, berita, kegiatan, kajian, galeri, dan fasilitas masjid kepada masyarakat.",
    stack: [
      "Laravel",
      "React JS",
      "Inertia JS",
    ...
    badges: ["🏛 Government Project"],
  },
  {
    title: "Reengineering Website Diskominfotik Provinsi Riau",
    category: "Government Digital Service",
    device: "desktop",
    desc: "Reengineering dan modernisasi website resmi Diskominfotik Provinsi Riau dengan pembaruan tampilan publik, pengelolaan konten, dokumen publik, berita, galeri, video, PPID, dan layanan digital yang responsif.",
    stack: [
      "Laravel 12",
      "React JS",
      "Inertia JS",
    ...
    image: "/Projects/Diskominfotik.png",
  ...
  },
  {
    ...
    device: "desktop",
    desc: "Perancangan antarmuka web aplikasi pembelian saham investasi PT Bank Riau Kepri Syariah menggunakan React JS.",
  ...
  },
  {
    ...
    device: "desktop",
    desc: "Website internal daftar urutan komposisi pemegang saham PT Bank Riau Kepri Syariah menggunakan Laravel, React, dan Inertia.",
    stack: [
      "Laravel",
      "React JS",
      "Inertia JS",
  ...
  },
  {
    ...
    category: "Internal System",
    device: "desktop",
    desc: "Website internal PT Bank Riau Kepri Syariah untuk pengelolaan Tanggung Jawab Sosial dan Lingkungan serta CSR.",
    stack: [
      "Laravel",
      "React JS",
      "Inertia JS",
  ...
  {
    title: "Website Corporate Event PT Bank Riau Kepri Syariah",
...
function getBadgeClass(badge: string): string {
  if (badge.includes("Government")) {
    return "border-blue-400/30 bg-blue-500/10 text-blue-300";
  }

  if (badge.includes("Banking")) {
    return "border-emerald-400/30 bg-emerald-500/10 text-emerald-300";
  }

  if (badge.includes("AI Project")) {
    return "border-violet-400/30 bg-violet-500/10 text-violet-300";
  }

  if (badge.includes("Mobile")) {
    return "border-pink-400/30 bg-pink-500/10 text-pink-300";
  }

  if (badge.includes("GIS")) {
    return "border-lime-400/30 bg-lime-500/10 text-lime-300";
  }

  if (badge.includes("Award")) {
...
export default function Projects() {
  return (
    <section
      id="projects"
      className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:py-28"
    >
      <motion.div
        initial={{
          opacity: 0,
      ...
      >
        <p className="mb-3 flex items-center justify-center gap-2 text-cyan-300">
          <FolderGit2 size={18} />
          Project Showcase
        </p>
        ...
        <p className="mx-auto mt-5 max-w-3xl px-2 text-sm leading-7 text-slate-400 sm:text-base sm:leading-8">
          Kumpulan project yang telah saya kembangkan sebagai
          Full Stack Developer, mulai dari sistem informasi,
          aplikasi GIS, machine learning, website pemerintahan,
          website perusahaan, hingga aplikasi manajemen dan
          ...
          return (
            ...
            >
              ...
              >
                <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                  ...
                  {project.badges?.map((badge) => (
                    <span
                      ...
                      className={`rounded-full border px-4 py-2 text-xs font-bold backdrop-blur-sm sm:text-sm ${getBadgeClass(
                        badge
                      )}`}
                    >
                      {badge}
                ...
                <h3 className="mt-5 text-2xl font-black leading-tight text-white sm:mt-6 sm:text-3xl md:text-5xl">
                  {project.title}
                </h3>
                ...
                <button
                  type="button"
                  className="mt-7 inline-flex items-center gap-3 rounded-xl border border-cyan-400/30 px-5 py-2.5 text-sm font-bold text-cyan-300 transition hover:bg-cyan-400 hover:text-slate-950 sm:mt-8 sm:px-6 sm:py-3 sm:text-base"
                >
                  Detail Project
                    ...
                    >
                      ...
                      >
                        <Image
                          ...
                          className="h-full w-full object-contain object-top transition-all duration-700 hover:scale-[1.03]"
                        />
                  ...
                  <div className="relative w-full">
                    ...
                    >
                      <Image
                        ...
                        className="h-auto w-full object-contain transition-all duration-700 hover:scale-[1.01]"
                      />
